...
That jumble of letters after `/ipfs/` is called a [*content identifier*]({{<relref "concepts/cid.md">}}) and it’s how IPFS can get content from multiple places.
...
Sounds interesting? We’ll cover [how to use it]({{<relref "introduction/using_ipfs.md">}}) next.
